//
//  ThirdPageOnboardingMainScreen.swift
//  HelpDoctor
//
...
class ThirdPageOnboardingMainScreen: UIViewController {
    ...
    private func setupThirdPageButton() {
        let size = 20.f
        thirdPageButton.layer.cornerRadius = 10
        thirdPageButton.backgroundColor = .hdButtonColor
        thirdPageButton.layer.borderWidth = 1
        thirdPageButton.layer.borderColor = UIColor.white.cgColor
    ...
    private func setupImage() {
        ...
        let imageName = "MenRightInCircle.pdf"
    ...
    private func setupTopLabel() {
        ...
        topLabel.text = "Эта кнопка приведет Вас к экрану контактов"
        ...
        topLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor,
                                          constant: 10.f).isActive = true
        topLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor,
                                           constant: -40.f).isActive = true
    ...
    private func setupBottomLabel() {
        ...
        bottomLabel.text = "Эта кнопка приведет Вас к экрану сообщений. Нажав на нее, Вы сможете просмотреть и ответить на сообщения"
    ...
    private func setupLeftArrowImage() {
        ...
        leftArrowImage.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
        leftArrowImage.trailingAnchor.constraint(equalTo: view.leadingAnchor, constant: (Session.width / 5) + (Session.width / 10)).isActive = true
        leftArrowImage.topAnchor.constraint(equalTo: topLabel.bottomAnchor, constant: 5).isActive = true
    ...
    private func setupRightArrowImage() {
        let imageName = "ThirdPageRightArrow.pdf"
        ...
        rightArrowImage.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -75).isActive = true
    ...
    @objc private func nextButtonPressed() {
        let onboardingVC = FourthPageOnboardingMainScreen()
