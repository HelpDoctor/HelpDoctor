...
public class PickerField: UITextField, UITextFieldDelegate {
    ...
    private func setupView() {
        ...
        addConstraint(bottomView,
                      toView: containerView,
                      top: nil,
                      leading: 0,
                      bottom: 0,
                      trailing: 0)
        bottomSectionHeightConstraint =
    ...
    private func addConstraint(_ view: UIView,
                               toView: UIView,
                               top: CGFloat?,
                               leading: CGFloat?,
                               bottom: CGFloat?,
    ...
    // MARK: - public methods
    public func show() {
        guard let alert = self.alert, !isShown else { return }
        ...
        getViewController()?.present(alert, animated: true, completion: { [weak self] in
            ...
            guard let unSelf = self, unSelf.cancelWhenTouchUpOutside else { return }
